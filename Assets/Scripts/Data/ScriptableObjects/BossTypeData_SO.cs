...
public class BossTypeData_SO : ScriptableObject
{
    ...
    public float P1_CloseAOEDuration = 1.5f;
    public int P1_RangedDamage = 10;
    public int P1_AOEDamage = 25;
    ...
    public float P2_CloseAOEDuration = 1.0f;
    public int P2_RangedDamage = 15;
    public int P2_AOEDamage = 40;
    ...
    public GameObject CloseAOEPrefab;
